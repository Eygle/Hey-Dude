...
public class GcmManager {
     ...
     */
    private String SENDER_ID = "804995116663";
    private GoogleCloudMessaging gcm;
    private String regid;


    public GcmManager(Activity c) {
        context = c;
        ...
        new Runnable() {
            ...
            public void run() {
                if (checkPlayServices()) {
                    Log.d(TAG, "check Play Services ok");
    ...
    private void sendRegistrationIdToBackend() {
        HeyDudeSessionVariables.token = regid;
        if (regid != null && HeyDudeSessionVariables.me != null) {
            ApiUtils.login();
        }
    }
